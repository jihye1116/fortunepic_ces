          ...
          <div className="font-pretendard mx-auto flex h-[80dvh] w-full flex-col gap-12 px-20 pb-10">
            ...
            <div className="flex flex-col gap-3 py-10">
              <Drawer.Title asChild>
                <h2 className="gradient-text text-[3.5rem] leading-[1.3] font-medium tracking-[-0.07rem]">
                  {t("information.gender.bottomSheet.title")}
                </h2>
              </Drawer.Title>
              <Drawer.Description asChild>
                <p className="text-[2.5rem] leading-[1.3] tracking-[-0.025rem] text-[#989BA2]">
                  {t("information.gender.bottomSheet.description")}
                </p>
              </Drawer.Description>
            </div>
            ...
            <div className="flex flex-col gap-5 py-10">
              <SecondaryButton onClick={handleContinue}>
                {t("information.gender.bottomSheet.continue")}
              </SecondaryButton>
              <CancelButton onCancel={() => onOpenChange(false)}>
                {t("information.gender.bottomSheet.selectGender")}
              </CancelButton>
            </div>
          </div>
        </Drawer.Content>
